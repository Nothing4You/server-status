...
?>
  ...
  <div id="login-form" class="center">
    ...
    if (isset($_POST['id']))
    {
      ...
      <a href="<?= WEB_PREFIX ?>/admin/?do=lost-password<?php echo "&id=".$_POST['id']."&token=".$_POST['token'];?>"><?php echo _("Go back");?> </a>
      <?php 
      }
        else{?>
        <p class="alert alert-success"><?php echo _("Password changed successfully!");?></p>
        <a href="<?= WEB_PREFIX ?>/admin/"><?php echo _("Go back to login page");?></a>
        <?php 
      }
    }
    else if (isset($_POST['email']))
    {
      ...
      if (isset($message)){?>
      <p class="alert alert-danger"><?php echo $message?></p>
      <a href="<?= WEB_PREFIX ?>/admin/?do=lost-password"><?php echo _("Go back to start");?></a>
      <?php 
      }
        else{?>
      ...
      <p class="alert alert-danger"><?php echo $message?></p>
      <?php }?>
      <form action="<?= WEB_PREFIX ?>/admin/?do=lost-password" method="post">
